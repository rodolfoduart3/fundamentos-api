...
Para subir o servidor Node localmente, basta executar:

```console
my@pc:~$ node server.js
```
-> O conteúdo do arquivo JSON será exibido acessando a porta [3100] (http://localhost:3100/clients/)

## FONTE DO CONTEÚDO

- Vídeo: https://www.youtube.com/watch?v=ghTrp1x_1As
- Repositório: https://github.com/rocketseat-content/youtube-api-rest-restful
